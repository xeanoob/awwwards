    ...
    <main className="bg-black text-white min-h-screen">
      ...
      <section className="relative pt-40 pb-24 px-8 md:px-16 min-h-[80vh] flex flex-col justify-center">
        ...
        <div className="max-w-3xl font-sans text-sm md:text-base opacity-80 mt-12">
          <p className="mb-6 font-medium text-xl">Global creative oversight for luxury fashion brands.</p>
          <p className="opacity-70 leading-relaxed">
            We bridge the gap between commercial objectives and artistic integrity. Our campaign direction ensures that every frame, every cut, and every interaction serves the brand&apos;s core protocol.
          </p>
        </div>
      </section>
      ...
      <section className="w-full aspect-video md:aspect-[21/9] bg-[#111] overflow-hidden">
        <Image 
          src="https://images.unsplash.com/photo-1556761175-b413da4baf72?auto=format&fit=crop&w=1920" 
          alt="Campaigns" 
          width={1920} 
          height={1080} 
