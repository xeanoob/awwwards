    ...
    <main className="bg-black text-white min-h-screen">
      ...
      <section className="relative pt-40 pb-24 px-8 md:px-16 min-h-[80vh] flex flex-col justify-center">
        ...
        <div className="max-w-3xl font-sans text-sm md:text-base opacity-80 mt-12">
          <p className="mb-6 font-medium text-xl">High-fidelity visual storytelling for premium publications.</p>
          <p className="opacity-70 leading-relaxed">
            We specialize in creating cohesive narrative arcs for editorial spreads. From location scouting to final color grading, our process is designed to elevate the brand's visual vocabulary.
          </p>
        </div>
      </section>
      ...
      <section className="w-full aspect-video md:aspect-[21/9] bg-[#111] overflow-hidden">
        <Image 
          src="https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?auto=format&fit=crop&w=1920" 
          alt="Editorial" 
          width={1920} 
          height={1080} 
