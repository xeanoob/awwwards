    ...
    <main className="bg-[#050505] text-[#F5F5F5] min-h-screen">
      ...
      <section className="py-24 px-8 md:px-16 grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="col-span-1 md:col-span-2 aspect-video bg-[#111] overflow-hidden group">
              <img src="/images/about.jpg" alt="Studio Setup" className="w-full h-full object-cover grayscale opacity-50 group-hover:scale-105 group-hover:opacity-100 transition-all duration-1000" />
          </div>

          <div className="col-span-1 aspect-[3/4] md:aspect-auto bg-[#111] overflow-hidden group">
              <img src="/images/gallery1.jpg" alt="Detail" className="w-full h-full object-cover grayscale opacity-50 group-hover:scale-105 group-hover:opacity-100 transition-all duration-1000" />
          </div>

          <div className="col-span-1 aspect-square bg-[#111] overflow-hidden group">
              <img src="/images/gallery2.jpg" alt="Equipment" className="w-full h-full object-cover grayscale opacity-50 group-hover:scale-105 group-hover:opacity-100 transition-all duration-1000" />
          </div>
      ...
      <section className="py-32 px-8 md:px-16 text-center max-w-4xl mx-auto flex flex-col items-center">
          ...
          <p className="font-sans text-[10px] uppercase tracking-[0.3em] opacity-40">1820 Internal Manifesto</p>
      </section>
